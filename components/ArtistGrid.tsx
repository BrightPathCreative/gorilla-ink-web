...
/** Frame glow — magenta / lime / yellow only */
const ARTICLE_FRAME: Record<ArtistFrame, string> = {
  magenta:
    "border-gorilla-magenta shadow-[0_0_32px_rgba(251,5,247,0.42),0_0_18px_rgba(251,5,247,0.24)]",
  lime: "border-gorilla-lime shadow-[0_0_32px_rgba(128,242,15,0.42),0_0_18px_rgba(128,242,15,0.24)]",
  yellow:
